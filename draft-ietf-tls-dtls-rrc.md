...
To prevent this, RRC cookies must be freshly generated using a reliable source of entropy (see {{?RFC4086}}).
A suitable source is the cryptographically secure pseudorandom number generator (CSPRNG) provided by the TLS implementation (see {{Appendix C.1 of RFC8446}}).
